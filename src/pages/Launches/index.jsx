        ...
        <div className="launches">
          ...
          <div className="launches_container2">
            <div className="launches_subcontainer2">
              <p className="launches_description2 reveal">
                Over the course of time, we have establish a total number of 110
                launches with 80 landings.
              </p>
              <p className="launches_description2 reveal">
                SpaceX's Falcon 9 will almost certainly be the most-launched
                rocket of this year.
              </p>
            </div>
          </div>
                ...
                {launches
                  .map((item, index) => (
                    <div className="launches_bordercontainer3" key={index}>
                      <h2 className="launches_name reveal">
                        {item.mission_name}
                      </h2>
                      <h3 className="launches_date reveal">
                        {moment(item.launch_date_utc).format("MMM DD YYYY")}
                      </h3>
                      <img
                        src={item.links.mission_patch}
                        alt=" "
                        className="launches_image reveal"
                      />
