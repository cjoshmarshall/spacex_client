    ...
    <div className='mission'>
      <div className='mission_container1'>
        <div className='mission_subcontainer1'>
          ...
          <h2 className='mission_subtitle1'>MAKING HUMANITY MULTIPLANETARY</h2>
          <p className='mission_description1'>SpaceX is working on a next generation of fully reusable launch vehicles that will be the most powerful ever built, capable of carrying humans to Mars and other destinations in the solar system.</p>
        </div>
      </div>
      <div className='mission_container2'>
          ...
          <div className='mission_subcontainer2' key={item.id}>
            <div className='mission_innercontainer2'>
                <p className='mission_date2 reveal'>{moment(item.event_date_utc).format('MMM DD yyyy')}</p>
