    ...
    const getRocket = async () => {
      try {
        const res = await axios.get(
          "https://api.spacexdata.com/v3/rockets/" + path
        );
        setRocket(res.data);
    ...
    <>
      {loading ? (
        <div className="rocket">
          <div
            className="rocket_container1"
            style={{
              backgroundImage: `url(${
                rocket.flickr_images && rocket.flickr_images[1]
              })`,
            }}
          >
            ...
            <div className="rocket_subcontainer3">
              ...
              <table className="rocket_innercontainer3">
                <tbody className="rocket_table3">
                  ...
                  <tr>
                    <td className="reveal">WEIGHT</td>
                    <td className="reveal">
                      {rocket.mass &&
                        `${rocket.mass.kg / 1000}kg/${
                          rocket.mass.lb / 1000
                        }lbs`}
                    </td>
                  </tr>
                  <tr>
                    <td className="reveal">DIAMETER</td>
                    <td className="reveal">
                      {rocket.diameter &&
                  ...
                  {rocket.payload_weights &&
                    rocket.payload_weights.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td className="reveal">
                          {item && `${item.kg / 1000}kg/${item.lb / 1000}lbs`}
                        </td>
                      </tr>
                    ))}
                </tbody>
            ...
            <div className="rocket_subcontainer3">
              ...
              <table className="rocket_innercontainer3">
                {rocket.engines && (
                  <tbody className="rocket_table3">
                    <tr>
                      <td className="reveal">NO. OF ENGINES</td>
                      <td className="reveal">{rocket.engines.number}</td>
                    </tr>
                    <tr>
                      <td className="reveal">ENGINE TYPE</td>
                      <td className="reveal">
                        {rocket.engines.type.toUpperCase()}
                      </td>
                    </tr>
                    <tr>
                      <td className="reveal">PROPELLANT 1</td>
                      <td className="reveal">{rocket.engines.propellant_1}</td>
                    </tr>
                    <tr>
                      <td className="reveal">PROPELLANT 2</td>
                      <td className="reveal">{rocket.engines.propellant_2}</td>
                    </tr>
                    <tr>
                      <td className="reveal">THRUST SEA LEVEL</td>
                      <td className="reveal">
                        {rocket.engines.thrust_to_weight}
                      </td>
                    </tr>
                    <tr>
                      <td className="reveal">NO. OF ENGINES LOSS</td>
                      <td className="reveal">
              ...
              <table className="rocket_innercontainer3">
                {rocket.first_stage && (
                  <tbody className="rocket_table3">
                    <tr>
                      <td className="reveal">NO. OF ENGINES</td>
                      <td className="reveal">{rocket.first_stage.engines}</td>
                    </tr>
                    <tr>
                      <td className="reveal">AMOUNT OF FUEL</td>
                      <td className="reveal">
                        {rocket.first_stage.fuel_amount_tons} ton
                      </td>
                    </tr>
                    <tr>
                      <td className="reveal">BURN TIME</td>
                      <td className="reveal">
                        {rocket.first_stage.burn_time_sec} sec
                      </td>
                    </tr>
                    <tr>
                      <td className="reveal">REUSABLE</td>
                      {rocket.first_stage.reusable ? (
                        <td className="reveal">YES</td>
                      ) : (
                        <td className="reveal">NO</td>
                      )}
                    </tr>
                    {rocket.first_stage.thrust_sea_level && (
                      <tr>
                        <td className="reveal">SEA LEVEL THRUST</td>
                        <td className="reveal">
                          {rocket.first_stage.thrust_sea_level.kN} kN/
                          {rocket.first_stage.thrust_sea_level.lbf / 1000} lbf
                        </td>
                      </tr>
                    )}
                    {rocket.first_stage.thrust_vacuum && (
                      <tr>
                        <td className="reveal">VACUUM THRUST</td>
                        <td className="reveal">
                          {rocket.first_stage.thrust_vacuum.kN} kN/
                          {rocket.first_stage.thrust_vacuum.lbf / 1000} lbf
                        </td>
                      </tr>
                    )}
                  </tbody>
              ...
              <table className="rocket_innercontainer3">
                {rocket.second_stage && (
                  <tbody className="rocket_table3">
                    <tr>
                      <td className="reveal">NO. OF ENGINES</td>
                      <td className="reveal">{rocket.second_stage.engines}</td>
                    </tr>
                    <tr>
                      <td className="reveal">AMOUNT OF FUEL</td>
                      <td className="reveal">
                        {rocket.second_stage.fuel_amount_tons} ton
                      </td>
                    </tr>
                    <tr>
                      <td className="reveal">BURN TIME</td>
                      <td className="reveal">
                        {rocket.second_stage.burn_time_sec} sec
                      </td>
                    </tr>
                    <tr>
                      <td className="reveal">REUSABLE</td>
                    ...
                    <tr>
                      <td className="reveal">PAYLOADS</td>
                      <td className="reveal">
